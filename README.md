...
**2026-09-17：0.2.2 远望与光照层次测试版。** 铁路下移并与缩放解耦，重排远山和薄云，按距离区分云的明暗、纹理与边缘，加入随日月方向变化的宽幅受光。仍待用户确认美术效果；本次 Windows 实测不能替代 Mac 原生与低配功耗验收。见[本轮改动与测试](docs/validation/VISUAL_PASS_0.2.2.md)、[第二阶段设计](docs/PHASE_2_DESIGN.md)和[Mac 测试说明](docs/MAC_TESTING.md)。
...
- Windows 0.2.2 测试包；2019 Intel Mac 网页基础体验正常，Mac 桌面版、低配功耗与最终审美认可仍待验证。当前以横屏为主。
