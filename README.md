...
**2026-09-17：0.2.1 视觉优化测试版。** 移除桥梁密集细线，修正连续日月轨迹，重调晴昼/暖霞/月夜色板、程序云团和山谷开口，并加入列车大面积明暗层次。仍待用户确认美术效果；本次 Windows 实测不能替代 Mac 原生与低配功耗验收。见[本轮改动与测试](docs/validation/VISUAL_PASS_0.2.1.md)、[第二阶段设计](docs/PHASE_2_DESIGN.md)和[Mac 测试说明](docs/MAC_TESTING.md)。
...
- Windows 0.2.1 测试包；2019 Intel Mac 网页基础体验正常，Mac 桌面版、低配功耗与最终审美认可仍待验证。当前以横屏为主。
